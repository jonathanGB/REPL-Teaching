...
do
	...
	if [ "$var" = "--restartDB" ]; then
		...
		mongo repl --eval 'db.createCollection("users"); db.users.insert([{ "_id" : ObjectId("58ae488a9d1fa299c7dc795a"), "name" : "topprof", "email" : "foo@bar", "role" : "teacher", "groups" : [ ], "password" : BinData(0,"JDJhJDEwJENwYmx3elNiWGhiVlpFWVZyUFdlY090VHJuQW0vbjdVc1pDMFpuQUpJQWhoaWQ0RHV1WXUy") }, { "_id" : ObjectId("58ae48e39d1fa299c7dc795b"), "name" : "topstudent", "email" : "student@bar", "role" : "student", "groups" : [ ObjectId("58ae4b00462a70ed0c38367d") ], "password" : BinData(0,"JDJhJDEwJGVqMk5Nd0JXbUJhRDlCalpBdXR5dnVnZmU5NlN0LkZQY0J3MS5VUlNRVFppWW9DLjhGOHhL") }]);' &&
		mongo repl --eval 'db.createCollection("groups"); db.groups.insert({"_id": ObjectId("58ae4b00462a70ed0c38367d"), name: "fou groupe", teacher: ObjectId("58ae488a9d1fa299c7dc795a"), files: [], password: BinData(0,"JDJhJDEwJENwYmx3elNiWGhiVlpFWVZyUFdlY090VHJuQW0vbjdVc1pDMFpuQUpJQWhoaWQ0RHV1WXUy")});'
	fi
done
